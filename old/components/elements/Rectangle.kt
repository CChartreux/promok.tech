package com.promok.tech.old.components.elements
...
fun Rectangle(
    ...
    Box(
        modifier = Modifier
            .width(width)
            .height(height)
            .backgroundColor(_root_ide_package_.com.promok.tech.old.components.theme.AppTheme.Colors.rgbaFromTriple(color, 1f))
            .borderRadius(borderRadius)
    ) {

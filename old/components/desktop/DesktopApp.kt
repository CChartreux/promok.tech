...
data class DesktopApp(
    ...
    val height: MutableState<CSSSizeValue<CSSUnit.px>> = mutableStateOf(_root_ide_package_.com.promok.tech.old.components.theme.AppTheme.Sizes.defaultWindowHeight),
    val width: MutableState<CSSSizeValue<CSSUnit.px>> = mutableStateOf(_root_ide_package_.com.promok.tech.old.components.theme.AppTheme.Sizes.defaultWindowWidth),
